...
export default function JoinUsPage() {
    ...
    return (
        <div
            className="no-reveal relative w-full min-h-screen"
            style={{
        ...
        >
            ...
            <div className="fixed inset-0 z-0 w-full h-full overflow-hidden">
                <iframe src="/3d-grid.html" className="w-full h-full border-none pointer-events-auto" title="3D Background Grid" />
                {/* Dark gradient overlay so text remains readable without hiding the awesome 3D cards */}
                <div className="absolute inset-0 bg-gradient-to-b from-black/20 via-black/30 to-[#080808]/60 pointer-events-none"></div>
            </div>

            {/* Main Foreground Content (Pass-through for mouse events, auto for children) */}
            <div className="relative z-10 w-full pointer-events-none">
                ...
                >
                    ...
                    />
                    <div className="pointer-events-auto" style={{ maxWidth: "900px", margin: "0 auto" }}>
                        <motion.span
                            initial={{ opacity: 0 }}
                            animate={{ opacity: 0.6 }}
                ...
                <section style={{ padding: "80px 40px", borderBottom: "1px solid rgba(255,255,255,0.05)" }}>
                    <div className="pointer-events-auto" style={{ maxWidth: "900px", margin: "0 auto" }}>
                        ...
                        <div className="mt-8 rounded-2xl bg-[#080808]/60 backdrop-blur-md shadow-2xl overflow-hidden ring-1 ring-white/10 p-2 sm:p-5">
                            <JoinForm />
                        </div>
                    </div>
                </section>
                ...
                {/* Benefits Grid */}
                <section style={{ padding: "80px 40px", borderBottom: "1px solid rgba(255,255,255,0.05)" }}>
                    <div className="pointer-events-auto" style={{ maxWidth: "1100px", margin: "0 auto" }}>
                        <motion.h2
                            initial="hidden"
                            whileInView="visible"
                            viewport={{ once: true }}
                        ...
                        >
                            {benefits.map((b, i) => (
                                ...
                                >
                                    ...
                                    <p style={{ fontSize: "0.875rem", lineHeight: 1.7, color: "#999" }}>{b.detail}</p>
                                </motion.div>
                            ))}
                        </motion.div>
                    </div>
                ...
                {/* Narrative */}
                <section style={{ padding: "80px 40px", paddingBottom: "160px" }}>
                    <motion.div
